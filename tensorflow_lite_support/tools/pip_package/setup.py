...
It consists of the following major components:
 - TFLite Support Util Library: a cross-platform library that helps to deploy
 TFLite models onto mobile devices.
 - TFLite Model Metadata: includes both human and machine readable information
 about what a model does and how to use the model.
 - TFLite Support Codegen: an executable that generates model interface
 automatically based on the TFLite Metadata and the Support Util Library. The
 model interface comes with high level APIs to interact with the model, such as
 loading and processing data, running inference, etc.
